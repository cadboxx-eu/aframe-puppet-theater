 ...
 */
AFRAME.registerComponent('puppet-controls', {
  schema: {
  ...
  init: function () {
      ...
      console.log("puppet-controls menuId: " + menuId);
      ...
      list.forEach(function (groupName, index) {
        ...
        var requestURL = 'https://rawgit.com/kfarr/aframe-city-builder/0.1.1/assets/' + groupName + ".json";
        ...
        request.onload = function() { // for each grouplist json file when loaded
          ...
          groupJSONArray[groupName].forEach( function(objectDefinition, index) {
            ...
            optionsHTML += `<option value="${objectDefinition["file"]}" src="https://rawgit.com/kfarr/aframe-city-builder/0.1.1/assets/preview/${objectDefinition["file"]}.jpg">${humanize(objectDefinition["file"])}</option>`
          });
...
//          resolve;
  ...
  onPlaceObject: function () {
    ...
    $('<a-entity />', {
      ...
      "obj-model": "obj: url(https://rawgit.com/kfarr/aframe-city-builder/0.1.1/assets/obj/" + objectArray[objectId].file + ".obj); mtl: url(https://rawgit.com/kfarr/aframe-city-builder/0.1.1/assets/obj/" + objectArray[objectId].file + ".mtl)",
      appendTo : $('#city')
    });
    ...
    thisItemEl.setAttribute('obj-model', { obj: "url(https://rawgit.com/kfarr/aframe-city-builder/0.1.1/assets/obj/" + objectArray[newObjectId].file + ".obj)",
                                          mtl: "url(https://rawgit.com/kfarr/aframe-city-builder/0.1.1/assets/obj/" + objectArray[newObjectId].file + ".mtl)"});
